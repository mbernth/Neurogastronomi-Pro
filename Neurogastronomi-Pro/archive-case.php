<?php
/**
 * This file adds the home template to the Neurogastronomi Pro.
 *
 * @author mono voce aps
 * @package Neurogastronomi Pro
...
function robin_do_taxonomy_loop() {
	...
	if ( ! is_wp_error( $terms ) ) {
		echo '<div class="gridcontainer"><div class="wrap toolbar mb2 mt2"><div class="coll1">
			 <button class="btn fil-cat active" href="" data-rel="all">'. __( 'All', 'neuro' ) .'</button>';
		foreach ( $terms as $term ) {
